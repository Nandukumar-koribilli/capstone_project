...
This capstone project for the Google AI Agents Intensive Course features an Automated Blog Writer Agent, a multi-agent system designed to streamline the blog writing process. Built using the Google Agent Development Kit (ADK), this agent reduces manual effort by automating research, planning, writing, editing, and social media promotion.

**Track:** Freestyle
**Problem:** Writing technical blogs is manual, time-intensive, and requires multiple skills like research, writing, and editing.
**Solution:** A multi-agent system that collaborates to produce high-quality blog posts efficiently, saving hours per week.

## 🚀 Quick Start

**New to this project?** Read the **[Complete Setup Guide](SETUP_GUIDE.md)** for step-by-step installation and usage instructions.
...
# 2. Add your Gemini API key to .env file (see SETUP_GUIDE.md)
...
- **Multi-agent system**: The agent consists of a main orchestrator and specialized sub-agents (planner, writer, editor, social media writer) that work together sequentially and in parallel.
- **Tools**: Custom tools for saving files and analyzing codebases, plus built-in Google Search tool for research.
- **Sessions & Memory**: Uses ADK's session management to maintain conversation state across interactions.
- **Observability**: Includes logging and evaluation frameworks for monitoring agent performance.
- **Agent evaluation**: Comprehensive evaluation suite with test cases to assess agent quality and reliability.
...
The Automated Blog Writer Agent is a multi-agent system composed of a main orchestrator agent and several specialized sub-agents.
...
This Automated Blog Writer Agent reduces the blog writing process by approximately 10 hours per week by automating:

- Research and outline generation
- First draft writing with accurate information
- Iterative editing based on feedback
- Social media content creation
- File export and organization

The multi-agent architecture ensures high-quality output while maintaining flexibility for user customization.
